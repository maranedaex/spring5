...
public class ClienteRestController {
	...
	//@ResponseStatus(HttpStatus.OK)  // es redundante dado que por defecto retorna 200, podemos omitirlo
	...
	public ResponseEntity<?> create(@Valid @RequestBody Cliente cliente, BindingResult result) {
		//cliente.setCreateAt(new Date()); //se reemplaza en el evento @PrePersist en clase Entity
...
//		  }
	      //EN JAVA 8 SE UTILIZA EL API STREAM con lambda
